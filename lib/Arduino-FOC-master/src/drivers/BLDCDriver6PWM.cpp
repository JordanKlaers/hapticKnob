...
int BLDCDriver6PWM::init() {
  ...
  Serial.println("pin c low");
  delay(100);
  pinMode(pwmC_l, OUTPUT);
  Serial.println("after pin modes");
  */
  ...
  Serial.println("After voltage limits");
  // set phase state to disabled
  ...
  Serial.println("After configuring");
  initialized = (params!=SIMPLEFOC_DRIVER_INIT_FAILED);
  Serial.println("after initialized");
