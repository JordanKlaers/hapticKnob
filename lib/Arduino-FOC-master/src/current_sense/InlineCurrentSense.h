...
class InlineCurrentSense: public CurrentSense{
  public:
    ...
    */
    ...
    InlineCurrentSense(Adafruit_INA219 *currentSensor_phase1, Adafruit_INA219 *currentSensor_phase2, Adafruit_INA219 *currentSensor_phase3);
  ...
  private:
    ...
    Adafruit_INA219 *sensor_phase1;
    Adafruit_INA219 *sensor_phase2;
    Adafruit_INA219 *sensor_phase3;
    // hardware variables
